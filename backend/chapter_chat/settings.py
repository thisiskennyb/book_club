"""
Django settings for chapter_chat project.
...
MIDDLEWARE = [
    'chapter_chat.middleware.CorsMiddleware',
...
ROOT_URLCONF = 'chapter_chat.urls'
...
WSGI_APPLICATION = 'chapter_chat.wsgi.application'
